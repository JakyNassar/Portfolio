...
function About() {
  return (
    <div className='mt-[50%] md:mt-[150px]'>
    <div className='flex flex-col items-center md:flex-row  sm:justify-around sm:mt-[50px] '>
     <div className='w-3/4 md:w-2/5 md:pt-5 '>
      <img className='w-full ' src="/Portfolio/about.png" alt="" />
     </div>
    <div className=' w-3/4 md:w-2/5 text-center justify-between '>
